...
> **"CallCRM owns the business truth. n8n moves information and triggers actions around that truth."**

CallCRM operates as a 100% self-contained application using Next.js 15 App Router, Supabase PostgreSQL, and PostgreSQL Row-Level Security. It does **not** depend on n8n for any core transactional functionality.
