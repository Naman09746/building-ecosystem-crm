...
export const updateOrgSettingsSchema = z.object({
  ...
  industry: z.enum(["real_estate", "building_materials", "interior_furniture", "architecture_design", "contractor_builder"]).optional(),
  complexityMode: z.enum(["simple", "deep"]).optional(),
