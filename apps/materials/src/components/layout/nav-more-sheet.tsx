...
export function NavMoreSheet({
  ...
  const sections: NavSection[] = [
    {
      title: "Materials & Field Operations",
      items: [
        { id: "footfall", label: "Walk-in Log", icon: Footprints },
        { id: "scouting", label: "Site Scouting", icon: Camera },
        { id: "khata", label: "Khata Ledger", icon: IndianRupee },
        { id: "rates", label: "Daily Rates", icon: TrendingUp },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { id: "projects", label: "Material Catalog", icon: Building2 },
