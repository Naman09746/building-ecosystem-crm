  ...
  return (
    <div className="space-y-4 animate-fade-up">
      ...
      {isMobile ? (
              ...
              visibleLeads
                ...
                .map((lead) => (
                  <div
                    ...
                    className="p-3.5 rounded-xl border border-border bg-card shadow-subtle hover:border-primary/40 hover-lift space-y-2.5 text-xs transition-all active:scale-[0.99] cursor-pointer"
                  >
        ...
        /* DESKTOP VIEW: Full Kanban Columns */
        <div className="flex gap-3 overflow-x-auto pb-4 pt-1 items-start">
          {STAGES.map((st) => {
            ...
            return (
              <div
                key={st.id}
                className="w-72 shrink-0 rounded-xl border border-border bg-secondary/30 flex flex-col max-h-[75vh] animate-fade-up"
              >
                {/* Column Header */}
                  ...
                  {stageLeads.length === 0 ? (
                    ...
                    stageLeads.map((lead) => (
                      <div
                        ...
                        className={`p-3 rounded-lg border bg-card shadow-subtle hover:border-primary/50 hover-lift cursor-pointer space-y-2 text-xs transition-all hover:shadow-card focus:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
