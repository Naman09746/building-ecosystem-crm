...
import type { Lead, ProjectUnit, NegotiationRound } from "@repo/core/types/crm";
...
export function NegotiationModal({
  ...
  // Confidential seller floor — derived only for managers; null for other roles prevents client-side leak
  const sellerFloorPrice: number | null = isManager ? Math.round(askPrice * 0.94) : null;
      ...
      <div className="p-5 border-b border-slate-800 bg-gradient-to-r from-slate-900 via-slate-900/80 to-slate-950">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-xs font-mono">
            {isManager && sellerFloorPrice !== null ? (
