...
import { PlanId, BillingCycle, BillingOverviewData, BillingInvoice, BillingRefund } from "@repo/core/types/billing";
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <Card className="border-border bg-card shadow-subtle">
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-xs">
            Provide official legal entity name and GSTIN to claim 18% Input Tax Credit on your EcosystemRealty tax invoices.
          </CardDescription>
        </CardHeader>
        <CardContent>
