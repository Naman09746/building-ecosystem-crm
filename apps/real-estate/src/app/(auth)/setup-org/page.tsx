...
import { EcosystemVertical, ComplexityMode } from "@repo/core/types/ecosystem";
...
export default function SetupOrgPage() {
  ...
  const [selectedVertical, setSelectedVertical] = React.useState<EcosystemVertical>(() => {
    ...
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("ecosystemrealty_signup_industry") as EcosystemVertical;
  ...
  const [orgName, setOrgName] = React.useState(() => {
    ...
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("ecosystemrealty_signup_industry");
      if (saved === "building_materials") return "Jindal Materials & Marble Yard";
    }
    return "Apex Realty Partners";
  });
