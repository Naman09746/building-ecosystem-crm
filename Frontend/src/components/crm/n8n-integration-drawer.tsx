      ...
      <div className="p-5 border-b border-slate-800 bg-gradient-to-r from-blue-950/40 via-slate-900 to-slate-950">
        ...
        <div className="mt-2">
          ...
          <p className="text-xs text-slate-400">
            CallCRM owns business truth (PostgreSQL + RLS). n8n handles external webhooks, WhatsApp, Google Calendar, and AI suggestions.
          </p>
        </div>
      </div>
