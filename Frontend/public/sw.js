// CallCRM 2.0 — Enterprise PWA Service Worker
const CACHE_NAME = "callcrm-cache-v1";
const STATIC_ASSETS = [
  "/",
  "/dashboard",
  "/leads",
...
self.addEventListener("push", (event) => {
  let data = { title: "CallCRM Alert", body: "New update received", url: "/dashboard" };
  try {
    if (event.data) {
  ...
  const options = {
    ...
    actions: [
      { action: "open", title: "Open CallCRM" },
