# Graph Report - Real-estate  (2026-09-01)

## Corpus Check
- 308 files · ~351,292 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3471 nodes · 6513 edges · 219 communities (214 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06a0cf22`
...
1. `apiError()` - 175 edges
2. `apiSuccess()` - 166 edges
3. `getApiAuthContext()` - 161 edges
4. `getAuthenticatedServerClient()` - 107 edges
5. `useCRM()` - 91 edges
6. `getServiceRoleClient()` - 91 edges
7. `isLiveSupabaseAvailable` - 81 edges
8. `checkRateLimit()` - 78 edges
9. `formatCurrencyINR()` - 62 edges
10. `handleValidationError()` - 61 edges
...
Cohesion: 0.09
Nodes (56): GET(), POST(), GET(), POST(), GET(), POST(), RouteParams, createCommissionSchema (+48 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (51): POST(), checkoutSchema, POST(), POST(), POST(), POST(), POST(), checkIdempotency() (+43 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (48): acceptInviteSchema, POST(), POST(), GET(), RouteParams, GET(), GET(), POST() (+40 more)
...
Cohesion: 0.12
Nodes (30): BillingSuccessView(), CostSheetModal(), CostSheetModalProps, SellerOpportunitiesModalProps, StackingChart(), StackingChartProps, UnitDetailModal(), UnitDetailModalProps (+22 more)

### Community 5 - "Community 5"
Cohesion: 0.13
Nodes (35): AiAgentCommandCenterProps, PRESET_BUYERS, AiResurrectionModal(), CommissionModal(), CommandItem, GlobalSearchDialogProps, LeadCard(), LeadCardProps (+27 more)
...
Cohesion: 0.08
Nodes (20): metadata, useAuth(), useCRM(), AiAgentCommandCenter(), AiLeadBot(), BossOverview(), GlobalSearchDialog(), AppShell() (+12 more)
...
Cohesion: 0.12
Nodes (24): GET(), escapeCsvField(), GET(), GET(), DELETE(), GET(), PATCH(), RouteParams (+16 more)

### Community 10 - "Community 10"
Cohesion: 0.11
Nodes (29): AiResurrectionModalProps, FilterSheet(), FilterSheetProps, FilterState, MeetingSummaryModalProps, NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer() (+21 more)

### Community 11 - "Community 11"
Cohesion: 0.1
Nodes (42): getSupabaseClient(), activityToRow(), AnyRow, completeTaskRemote(), CrmHydration, deleteDocumentRemote(), deleteProjectRemote(), deleteRegionRemote() (+34 more)
...
Cohesion: 0.12
Nodes (36): CRMContext, CRMContextType, INITIAL_ACTIVITIES, INITIAL_AREAS, INITIAL_DOCUMENTS, INITIAL_EXTERNAL_ORGS, INITIAL_LEADS, INITIAL_ORG (+28 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (39): 100-Point Bi-Directional Matcher Algorithm, 1. Salesperson Workspace (Action-First), 2-Minute Full Presentation Script (For Investors & Agency Heads), 2. Sales Manager Workspace (Intervention-First), 30-Second Elevator Pitch (For Founders & Sales Directors), 3. Boss / Agency Founder Workspace (Macro Health & Revenue-First), CallCRM 2.0 — Master Product Audit, Selling Playbook & Complete UI/UX Redesign Blueprint, CallCRM UX Scorecard (+31 more)
...
Cohesion: 0.14
Nodes (24): useIsDesktop(), useIsMobile(), useIsTablet(), TopBarProps, PlanItem, PLANS_DATA, LeadsPage(), LeadsPageProps (+16 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (27): ActivityHeatmap(), DAYS, HEATMAP_DATA, HOURS, AreaTrendChart(), DataPoint, DEFAULT_SERIES, CircularProgress() (+19 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (35): DetectSellerSignalsResult, AuditLog, BuyerRequirement, CommissionLedger, CommissionPaymentStatus, DealHealthFactor, DispatchStatus, FactCategory (+27 more)
...
Cohesion: 0.15
Nodes (18): CommissionModalProps, N8nIntegrationDrawerProps, NegotiationModalProps, QuickActivityModal(), QuickActivityModalProps, StructuredOutcome, VoiceNoteRecorder(), VoiceNoteRecorderProps (+10 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (32): bulkImportUnitsSchema, createDocumentSchema, createExternalOrgSchema, createInvitationSchema, createProjectSchema, createRegionSchema, createTaskSchema, executeResurrectionSchema (+24 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (31): 1. 🏛️ System Specifications (`DOCS/system-spec/`), 2. ⚡ Technical Domain Guides (`DOCS/domain-guides/`), 3. 🎨 CRM UI/UX Redesign Specifications (`DOCS/ui-ux-spec/`), 4. 🌐 Marketing Website Specifications (`DOCS/marketing-spec/`), 5. 💼 Executive Playbooks & Audits (`DOCS/playbooks/`), CallCRM 2.0 — Architecture & Documentation Hub, code:block1 (DOCS/), 📚 Documentation Directory Structure (+23 more)
...
Cohesion: 0.07
Nodes (28): ARCHITECTURE ASSESSMENT, CALLCRM PRODUCTION-READINESS AUDIT & IMPLEMENTATION ROADMAP, Critical Issues (P0), EXECUTIVE SUMMARY, IMMEDIATE ACTION ITEMS (COMPLETED & VERIFIED), Important Issues (P1), Nice-to-Have (P3), PHASE 11-18: RELIABILITY, SCALABILITY, UX AUDIT (+20 more)
...
Cohesion: 0.11
Nodes (25): messageShapeSchema, AriaToolContext, CustomerDossierInput, customerDossierInputSchema, getCustomerDossier(), LookupBuyerInput, lookupBuyerInputSchema, lookupDocuments() (+17 more)

### Community 35 - "Community 35"
Cohesion: 0.15
Nodes (21): fraunces, ibmPlexMono, inter, metadata, RootLayout(), viewport, AuthProvider(), CRMProvider() (+13 more)
...
Cohesion: 0.12
Nodes (24): leadToRow(), mapActivityRow(), mapActivityType(), mapDocumentRow(), mapFactRow(), mapLeadRow(), mapPersonRow(), mapProjectRow() (+16 more)

### Community 41 - "Community 41"
Cohesion: 0.08
Nodes (24): CallCRM — Screen-by-Screen Landing Page Redesign Specification, code:block1 (+-----------------------------------------------------------), code:block10 (+-----------------------------------------------------------), code:block11 (+-----------------------------------------------------------), code:block2 (+-----------------------------------------------------------), code:block3 (+-----------------------------------------------------------), code:block4 (+-----------------------------------------------------------), code:block5 (+-----------------------------------------------------------) (+16 more)
...
Cohesion: 0.08
Nodes (23): isSubscriptionActive(), cancelSubscriptionSchema, createCheckoutSessionSchema, createRefundSchema, updateBillingProfileSchema, atQuota, expiredGrace, futureGrace (+15 more)
...
Cohesion: 0.09
Nodes (21): 01. Product Requirements Document (PRD) — Apex Realty CallCRM, 1.1 The High-Ticket Real Estate Challenge, 1.2 The CallCRM Solution, 1. Executive Summary & Problem Statement, 2. User Personas & Roles, 3.10 Autonomous AI Agent Suite (Aria & Resurrection Engine), 3.1 Master Contact Identity & Phone Deduplication, 3.2 7-Stage Luxury Sales Pipeline (+13 more)

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (15): ChoosePlanPage(), PLANS, PlanTier, LoginForm(), DEFAULT_STAGES, OnboardingPage(), OnboardingStep, REGIONS (+7 more)
...
Cohesion: 0.1
Nodes (18): calculateUnitMatchScore(), SearchInventoryInput, authA, authB, criteria, highFloorReq, highResult, invalid (+10 more)
...
Cohesion: 0.1
Nodes (19): mapAreaRow(), mapExternalOrgRow(), generatePropertyBriefing(), matchBuyersForUnit(), propertyBriefingInputSchema, createEntityRelationshipSchema, createProjectTowerSchema, createProjectUnitSchema (+11 more)

### Community 58 - "Community 58"
Cohesion: 0.1
Nodes (14): aiExtractionFromN8n, AiExtractionPayload, approvedCheck, eventPayload, firstAttempt, InboundEventLog, InboundWebhookIdempotencyManager, isValid (+6 more)
...
Cohesion: 0.12
Nodes (17): 02. System Architecture Document — Apex Realty CallCRM, 02. System Architecture Document — CallCRM 2.0, 1. High-Level Architecture Topology, 2.1 Web Application & Router (`Frontend/src/app/`), 2.2 Global State & Optimistic UI (`Frontend/src/context/crm-context.tsx`), 2.3 CallCRM + n8n Integration Layer (`Frontend/src/lib/server/domain-event-bus.ts`), 2.3 Unified Data Service (`Frontend/src/lib/services/crm-data-service.ts`), 2.4 Enterprise Server Security Layer (`Frontend/src/lib/server/api-security.ts`) (+9 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (17): confirmMeetingDispositionSchema, createSellerOpportunitySchema, freeTextMeetingSummarySchema, siteVisitBriefingInputSchema, updateSellerOpportunitySchema, criteria, disposition, invalid (+9 more)

### Community 70 - "Community 70"
Cohesion: 0.16
Nodes (16): calculateCostSheet(), CostSheetBreakdown, CostSheetParameters, getDefaultCostParameters(), getStandardMilestones(), getStandardStampDutyPct(), IndianState, PaymentMilestone (+8 more)

### Community 71 - "Community 71"
Cohesion: 0.12
Nodes (14): billingNotif, crossTenantQuery, leadNotif, list, markAllForUser1, mockNotifications, notif, nowIso (+6 more)

### Community 72 - "Community 72"
Cohesion: 0.12
Nodes (15): 04. Database & Data Model Specification — Apex Realty CallCRM, 1. Entity Relationship Diagram (Conceptual), 2.1 `public.organizations` (Tenant Partition), 2.2 `public.people` (Master Contact & Phone Dedup Anchor), 2.3 `public.projects` (Development Catalog), 2.4 `public.project_units` (Inventory Matrix), 2.5 `public.leads` (Sales Opportunities), 2.6 `public.activities` (Immutable Audit Stream) (+7 more)
...
Cohesion: 0.12
Nodes (14): 08. Test Strategy & Test Plan — Apex Realty CallCRM, 1. Test Architecture & Strategy Pyramid, 2.1 `phone-dedup.test.ts` (Phone Normalization & Currency Formatting), 2.2 `rate-limiting.test.ts` (Token Bucket & Idempotency), 2.3 `validations.test.ts` (Zod Inbound Payload Verification), 2.4 `webhook-security.test.ts` (HMAC-SHA256 Cryptographic Verification), 2.5 `subscription.test.ts` (Plan Quotas & Feature Gating), 2.6 `crm-sync-mappers.test.ts` & Supporting Suites (+6 more)
...
Cohesion: 0.13
Nodes (14): aiAgentQualifySchema, createActivitySchema, createLeadSchema, phoneSchema, resurrectScanSchema, absurdBudget, badMetadata, injectionAttempt (+6 more)

### Community 78 - "Community 78"
Cohesion: 0.13
Nodes (13): 05. Security & Threat Model — Apex Realty CallCRM, 1. Threat Modeling Overview (STRIDE Matrix), 2.1 Broken Object Level Authorization (BOLA / IDOR), 2.2 Broken Authentication & Session Management, 2.3 AI Agent Prompt Injection & Autonomous Action Attack, 2.4 Webhook Forgery & Replay Attacks, 2.4 Webhook Forgery, Replay Attacks & Idempotency, 2.5 Domain Event Outbox & Circuit Breaker Security (+5 more)
...
Cohesion: 0.13
Nodes (14): 1. System Architecture & Component Map, 2. Full Security & Isolation Matrix, 3. Data Integrity & Database Hardening (Migrations 0001–0021), 4. Verification & Test Suite Summary, 5. Production Deployment Runbook, CallCRM — Production Readiness & Deployment Guide, code:mermaid (graph TD), code:block2 (============================================================) (+6 more)
...
Cohesion: 0.19
Nodes (11): InboundLeadParams, ingestInboundLead(), IngestionResult, normalizeBudget(), normalizeConfiguration(), assignments, counts, hmac (+3 more)

### Community 83 - "Community 83"
Cohesion: 0.18
Nodes (12): AuthContext, AuthContextType, AuthOrg, AuthUser, loadProfileUser(), loadProfileUserAndOrg(), mapDbRole(), OnboardingData (+4 more)

### Community 84 - "Community 84"
Cohesion: 0.14
Nodes (13): 1. Executive Summary & Core UX Diagnosis, 2. Complete Surface Inventory, 3. Deep Interaction & Usability Issues, 4. Architectural Ledger Design System Evaluation, A. Core Sales Surfaces, B. Property Intelligence Surfaces, C. Intelligence & Automation Surfaces, CallCRM 2.0 — Complete UX/UI Product Audit (+5 more)
...
Cohesion: 0.26
Nodes (10): LandingPage(), ArchitecturalFloorplanVector(), ExecutiveDarkCockpit(), HeroDossierPreview(), HeroEditorialVisual(), IsometricCityscape(), MobileCompanionDeviceFrame(), PhysicalSiteVisitShowcase() (+2 more)

### Community 93 - "Community 93"
Cohesion: 0.24
Nodes (11): fetchMetaLeadData(), GET(), isFreshWebhookTime(), parseFieldData(), POST(), timingSafeCompare(), verifyHmacSignature(), metaLeadAdsWebhookSchema (+3 more)

### Community 94 - "Community 94"
Cohesion: 0.15
Nodes (11): 11. Architecture Decision Records (ADRs) — Apex Realty CallCRM, ADR 001: Next.js 15 App Router & React 19 as the Core Full-Stack Framework, ADR 002: PostgreSQL Row-Level Security (RLS) for Multi-Tenant Data Isolation, ADR 003: Master `people` Table as the E.164 Phone Deduplication Anchor, ADR 004: Human-in-the-Loop Approval Gate for AI Lead Qualification, ADR 005: Graphify AST Knowledge Graph for Zero-Token Codebase Navigation, ADR 006: CallCRM + n8n Separation of Responsibilities & Transactional Domain Event Outbox, ADR 007: Digital Site Visit Pass & Geofenced Check-in Protocol (+3 more)
...
Cohesion: 0.18
Nodes (10): [0.5.0] - 2026-08-20 — Frontend Visual MVP Release, 12. Changelog & Release Notes — Apex Realty CallCRM, [1.0.0] - 2026-08-22 — Enterprise Production Release, [2.0.0] - 2026-08-31 — CallCRM 2.0 & n8n Separation of Responsibilities Architecture, 🚀 Added, 🚀 Added, 🚀 Added, 🚀 Added (+2 more)
...
Cohesion: 0.33
Nodes (9): lead, leadWithUnit, lostLead, setup(), targets, task, useTestCRM(), wrapper() (+1 more)

### Community 103 - "Community 103"
Cohesion: 0.18
Nodes (10): 1. Implementation Phases & Execution Order, 2. Detailed Screen-by-Screen Specifications, CallCRM 2.0 — Screen-by-Screen UI/UX Redesign Plan, code:mermaid (flowchart LR), Screen 1: Salesperson Daily Priority Cockpit (`salesperson-home.tsx`), Screen 2: Flat 360° Master Property Dossier (`unit-detail-modal.tsx` $\rightarrow$ `UnitDossierSheet.tsx`), Screen 3: Executive Boss & Agency Founder Cockpit (`boss-overview.tsx`), Screen 4: Leads Directory & Slide-Over Dossier (`leads-page.tsx`, `lead-detail-modal.tsx`) (+2 more)

### Community 104 - "Community 104"
Cohesion: 0.18
Nodes (10): 1. Executive Comparison Summary, 2. Detailed Screen Transformations, CallCRM 2.0 — Screen-by-Screen Before & After Map, code:block1 (------------------------------------------------------------), code:block2 (============================================================), code:block3 (============================================================), code:block4 (============================================================), Surface 1: Salesperson Daily Home (+2 more)
...
Cohesion: 0.18
Nodes (10): 1. Executive Transformation Matrix, 2. Section-by-Section Detailed Transformations, CallCRM — Marketing Website Before & After Transformation Map, code:block1 (------------------------------------------------------------), code:block2 (============================================================), code:block3 (============================================================), code:block4 (============================================================), Section 1: Hero Section (+2 more)
...
Cohesion: 0.36
Nodes (9): whatsappWebhookSchema, fromPhoneNormalized(), GET(), isFreshWebhook(), POST(), ResolvedOrg, resolveOrgForSource(), senderNameSafe() (+1 more)

### Community 114 - "Community 114"
Cohesion: 0.29
Nodes (10): 2.13 Billing & Subscriptions API, 2.4 Webhooks API (Inbound Event Receivers), 2.5 Billing & Subscriptions API, 2.9 Webhooks API (Inbound Event Receivers), 2. API Endpoints Catalog, `GET & POST /api/webhooks/meta-lead-ads`, `GET & POST /api/webhooks/retry`, `GET & POST /api/webhooks/whatsapp` (+2 more)
...
Cohesion: 0.22
Nodes (8): AiLeadBotProps, ChatMessage, QualifiedLeadCardData, QUICK_PROMPTS, DocumentItemSummary, ExistingBuyerMatch, NextActionRecommendation, ScoredUnitMatch

### Community 122 - "Community 122"
Cohesion: 0.28
Nodes (7): CreateNotificationParams, AutomationLogItem, NotificationItem, NotificationPreferences, NotificationPriority, NotificationType, SLAConfiguration
...
Cohesion: 0.22
Nodes (8): 1. Component Layering Architecture, 2. Component Inventory & Classification, 3. Consolidation & Deprecation Strategy, 4. State Management & Performance Boundary, CallCRM 2.0 — Component Strategy & Architecture, code:mermaid (graph TD), Layer 1: Core Primitives (`src/components/ui/*`), Layer 2: Domain Composite Components (`src/components/crm/*`)
...
Cohesion: 0.22
Nodes (7): 1. Global Architectural Foundation, 3. Global Header & Overlay Components, 4. Verification Matrix: 100% Non-Overlapping & Orthogonal Features, 5. Technical Investor Pitch Summary, 📖 CallCRM Master Feature, Screen & Data Flow Encyclopedia, code:mermaid (graph TD), code:block8 (┌───────────────────────────────────────────────────────────)
...
Cohesion: 0.29
Nodes (6): createDispatchSchema, GET(), n8nInboundPayloadSchema, POST(), dispatchPendingOutboxEvents(), emitDomainEvent()

### Community 135 - "Community 135"
Cohesion: 0.25
Nodes (6): 03. API Documentation — Apex Realty CallCRM, 1.1 Standard Success Envelope (`200 OK`, `201 Created`), 1.2 Standard Error Envelope (`400`, `401`, `403`, `422`, `429`, `500`), 1. Global API Standards & Envelopes, code:json ({), code:json ({)
...
Cohesion: 0.25
Nodes (7): 1. Component Layering Architecture, 2. Component Inventory & Classification, 3. Visual Asset Refactoring & Consolidation, CallCRM — Marketing Component Strategy & Architecture, code:mermaid (graph TD), Layer 1: Marketing Primitives (`src/components/marketing/primitives/*`), Layer 2: Product Showcase Containers (`src/components/marketing/showcases/*`)
...
Cohesion: 0.29
Nodes (5): POST(), validateMessages(), checkRateLimitDurable(), key, rpcMock
...
Cohesion: 0.29
Nodes (4): CommissionInput, input, ledger, metrics
...
Cohesion: 0.29
Nodes (6): CallCRM 2.0 — Complete UX/UI Master Redesign Blueprint, Screen 1: Salesperson Daily Priority Cockpit (`salesperson-home.tsx`), Screen 2: Flat 360° Master Property Dossier (`unit-detail-modal.tsx` $\rightarrow$ `UnitDossierSheet.tsx`), Screen 3: Executive Boss & Agency Founder Cockpit (`boss-overview.tsx`), Section 4: Screen-by-Screen UI Redesign Implementation Plan, Section 5: Screen Priority & Impact Matrix (P0–P3)

### Community 154 - "Community 154"
Cohesion: 0.29
Nodes (6): 13.1 Core Architecture Axiom, 13.2 Enterprise Domain Hierarchy & Database Schema (Migration 0020 & 0021), 13.3 AI Safety Protocol, 13. CALLCRM 2.0 ENTERPRISE DOMAIN LAYER & N8N INTEGRATION ARCHITECTURE, CallCRM 2.0 — Master Frontend & System Encyclopedia, Master Table of Contents

### Community 155 - "Community 155"
Cohesion: 0.29
Nodes (6): 1. Core Architectural Pillars, 2. PostgreSQL Row-Level Security Matrix, 3. Separation of Responsibilities Architecture, 4. Verification & Hardening, code:block1 (┌───────────────────────────────────────────────────────────), Enterprise Multi-Tenant SaaS Backend Architecture — CallCRM 2.0
...
Cohesion: 0.33
Nodes (5): AggregateType, CrmDomainEventName, DomainEventRecord, EmitEventInput, inMemoryOutbox
...
Cohesion: 0.33
Nodes (6): A. What You See on the Screen:, B. Data Source & SQL Table Origin:, C. Technical Mechanics:, code:sql (SELECT), D. Non-Repetition Proof:, 📇 Module 6: People Directory & 360° Contact Dossier (`/people`)
...
Cohesion: 0.33
Nodes (5): 1. Executive Summary & Brand Positioning Diagnosis, 2. Complete Section Inventory & Friction Audit, 3. Brand Tone & Visual Language Diagnosis, CallCRM — Marketing Website Visual & Experience Audit, code:block1 (------------------------------------------------------------)
...
Cohesion: 0.4
Nodes (4): 1. Complete Screen Priority Matrix, 2. Resource & Phasing Allocation, CallCRM 2.0 — Screen Priority & Impact Matrix, code:block1 (Total Scope Breakdown:)
...
Cohesion: 0.5
Nodes (4): CallCRM UX Scorecard, code:block10 (PHASE 0: Design Tokens & Foundations (P0)), Phased Implementation Roadmap, Section 8: CallCRM UX Scorecard & Phased Execution Roadmap

### Community 199 - "Community 199"
Cohesion: 0.5
Nodes (4): 30. CallCRM UX Scorecard, 31. Complete 11-Phase Implementation Roadmap, code:block8 (PHASE 0: Design Tokens & Foundations (P0)), Part VI: Scorecard & Master Execution Roadmap
...
Cohesion: 0.67
Nodes (3): 2.6 Enterprise Financials & Cost Sheet Calculator API, code:json ({), `POST /api/financials/cost-sheet`

### Community 208 - "Community 208"
Cohesion: 0.67
Nodes (3): 2.8 Autonomous AI Agent APIs, `POST /api/agent/resurrect`, `POST /api/chat`
...
## Knowledge Gaps
- **1793 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1788 more)
...
- **Why does `apiError()` connect `Community 0` to `Community 1`, `Community 2`, `Community 34`, `Community 165`, `Community 134`, `Community 9`, `Community 145`, `Community 113`, `Community 93`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `getServiceRoleClient()` connect `Community 2` to `Community 0`, `Community 1`, `Community 34`, `Community 164`, `Community 134`, `Community 9`, `Community 15`, `Community 113`, `Community 82`, `Community 145`, `Community 22`, `Community 57`, `Community 122`, `Community 93`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `isLiveSupabaseAvailable` connect `Community 9` to `Community 0`, `Community 1`, `Community 2`, `Community 34`, `Community 164`, `Community 134`, `Community 15`, `Community 113`, `Community 82`, `Community 22`, `Community 122`, `Community 93`?**
