...
## Corpus Check
- 304 files · ~343,668 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3326 nodes · 6322 edges · 201 communities (194 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c330aa9e`
...
5. `getServiceRoleClient()` - 91 edges
6. `useCRM()` - 89 edges
7. `isLiveSupabaseAvailable` - 81 edges
8. `checkRateLimit()` - 78 edges
9. `handleValidationError()` - 61 edges
10. `formatCurrencyINR()` - 60 edges
...
## Communities (201 total, 7 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (72): POST(), POST(), checkoutSchema, POST(), POST(), POST(), POST(), POST() (+64 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (67): GET(), POST(), GET(), POST(), GET(), createCommissionSchema, GET(), POST() (+59 more)
...
Cohesion: 0.05
Nodes (51): fetchMetaLeadData(), GET(), isFreshWebhookTime(), parseFieldData(), POST(), timingSafeCompare(), InboundLeadParams, ingestInboundLead() (+43 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (23): metadata, useCRM(), AiAgentCommandCenter(), AiLeadBot(), BossOverview(), GlobalSearchDialog(), PipelineBoard(), AppShell() (+15 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (42): POST(), RouteParams, DELETE(), GET(), PATCH(), RouteParams, normalizePhone(), POST() (+34 more)

### Community 6 - "Community 6"
Cohesion: 0.15
Nodes (28): CostSheetModal(), CostSheetModalProps, N8nIntegrationDrawer(), N8nIntegrationDrawerProps, StackingChart(), StackingChartProps, UnitDetailModal(), UnitDetailModalProps (+20 more)

### Community 7 - "Community 7"
Cohesion: 0.1
Nodes (35): AiAgentCommandCenterProps, PRESET_BUYERS, CommissionModal(), CommandItem, GlobalSearchDialogProps, LeadCardProps, LeadDetailModal(), LeadDetailModalProps (+27 more)
...
Cohesion: 0.13
Nodes (29): LeadCard(), QuickActivityModal(), QuickActivityModalProps, StructuredOutcome, useIsDesktop(), useIsMobile(), useIsTablet(), formatPhone() (+21 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (34): POST(), GET(), POST(), GET(), GET(), PATCH(), PATCH(), GET() (+26 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (32): ActivityHeatmap(), DAYS, HEATMAP_DATA, HOURS, AreaTrendChart(), DataPoint, DEFAULT_SERIES, CircularProgress() (+24 more)

### Community 13 - "Community 13"
Cohesion: 0.13
Nodes (41): getSupabaseClient(), isSupabaseConfigured, activityToRow(), AnyRow, completeTaskRemote(), CrmHydration, deleteDocumentRemote(), deleteProjectRemote() (+33 more)

### Community 14 - "Community 14"
Cohesion: 0.11
Nodes (29): AiResurrectionModal(), AiResurrectionModalProps, FilterSheet(), FilterSheetProps, FilterState, NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer() (+21 more)
...
Cohesion: 0.07
Nodes (38): insertUnitRemote(), mapActivityRow(), mapActivityType(), mapAreaRow(), mapDocumentRow(), mapExternalOrgRow(), mapFactRow(), mapLeadRow() (+30 more)
...
Cohesion: 0.09
Nodes (24): acceptInviteSchema, POST(), GET(), POST(), RouteParams, generateCostSheetWhatsAppText(), checkRateLimit(), checkRateLimitDurable() (+16 more)
...
Cohesion: 0.17
Nodes (16): GET(), escapeCsvField(), GET(), GET(), GET(), POST(), GET(), mapRawDashboardAnalytics() (+8 more)
...
Cohesion: 0.12
Nodes (23): 1. Database setup, 2. Environment, 3. Run, 3. Run & Test, 🧠 AI Agents & Automation Modules, Apex Realty CallCRM — Architectural Real Estate Sales & AI Agent Command Center, CallCRM 2.0 — Architectural Real Estate Sales Operating System & n8n Automation Engine, 🏛️ CallCRM + n8n Separation-of-Responsibilities Architecture (+15 more)
...
Cohesion: 0.14
Nodes (16): ChoosePlanPage(), PLANS, PlanTier, useAuth(), NotificationBell(), LoginForm(), DEFAULT_STAGES, OnboardingPage() (+8 more)
...
Cohesion: 0.2
Nodes (10): AuthContext, AuthContextType, AuthOrg, AuthUser, loadProfileUser(), mapDbRole(), OnboardingData, STORAGE_KEYS (+2 more)

### Community 96 - "Community 96"
Cohesion: 0.18
Nodes (11): 2.4 Digital Site Visit Pass API, 2.6 Enterprise Financials & Cost Sheet Calculator API, 2.8 Autonomous AI Agent APIs, 2. API Endpoints Catalog, code:json ({), code:json ({), `GET /api/leads/[id]/site-visit-pass`, `POST /api/agent/resurrect` (+3 more)
...
Cohesion: 0.46
Nodes (4): VoiceNoteRecorder(), VoiceNoteRecorderProps, useVoiceRecorder(), VoiceRecorderState
...
## Knowledge Gaps
- **1710 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1705 more)
...
- **Why does `apiError()` connect `Community 1` to `Community 32`, `Community 0`, `Community 3`, `Community 5`, `Community 11`, `Community 25`, `Community 158`, `Community 30`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 48` to `Community 4`, `Community 6`, `Community 13`, `Community 14`, `Community 84`, `Community 85`, `Community 24`, `Community 95`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `reportError()` connect `Community 158` to `Community 24`, `Community 1`, `Community 11`, `Community 13`?**
