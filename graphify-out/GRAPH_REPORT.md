...
## Corpus Check
- 305 files · ~345,058 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3364 nodes · 6405 edges · 202 communities (197 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b578bbbb`
...
## Communities (202 total, 5 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.08
Nodes (71): GET(), POST(), GET(), POST(), GET(), createCommissionSchema, GET(), POST() (+63 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (73): POST(), checkoutSchema, POST(), POST(), POST(), GET(), POST(), POST() (+65 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (30): useAuth(), useCRM(), AiAgentCommandCenter(), AiLeadBot(), BossOverview(), GlobalSearchDialog(), PipelineBoard(), STAGES (+22 more)
...
Cohesion: 0.12
Nodes (39): AiAgentCommandCenterProps, PRESET_BUYERS, CommissionModal(), CommandItem, GlobalSearchDialogProps, LeadCard(), LeadCardProps, LeadDetailModal() (+31 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (35): AiResurrectionModal(), AiResurrectionModalProps, MeetingSummaryModalProps, N8nIntegrationDrawerProps, NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer(), NotificationsDrawerProps (+27 more)
...
Cohesion: 0.08
Nodes (41): acceptInviteSchema, POST(), normalizePhone(), fetchMetaLeadData(), GET(), isFreshWebhookTime(), parseFieldData(), POST() (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (39): POST(), RouteParams, DELETE(), GET(), PATCH(), RouteParams, normalizePhone(), POST() (+31 more)
...
Cohesion: 0.14
Nodes (27): BillingSuccessView(), CostSheetModal(), CostSheetModalProps, StackingChart(), StackingChartProps, UnitDetailModal(), UnitDetailModalProps, metadata (+19 more)
...
Cohesion: 0.07
Nodes (41): mapActivityRow(), mapActivityType(), mapAreaRow(), mapDocumentRow(), mapExternalOrgRow(), mapFactRow(), mapLeadRow(), mapPersonRow() (+33 more)
...
Cohesion: 0.09
Nodes (30): CRMContext, CRMContextType, INITIAL_ACTIVITIES, INITIAL_AREAS, INITIAL_DOCUMENTS, INITIAL_EXTERNAL_ORGS, INITIAL_ORG, INITIAL_PEOPLE (+22 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (30): CommissionModalProps, SiteVisitDispatchModalProps, AuditLog, BuyerRequirement, CommissionLedger, CommissionPaymentStatus, DealHealthFactor, DispatchStatus (+22 more)
...
Cohesion: 0.15
Nodes (18): POST(), GET(), escapeCsvField(), GET(), GET(), GET(), POST(), GET() (+10 more)
...
Cohesion: 0.17
Nodes (18): metadata, PlanItem, PLANS_DATA, UsersPage(), Person, TeamInvitation, Avatar, AvatarFallback (+10 more)
...
Cohesion: 0.15
Nodes (20): FilterSheet(), FilterSheetProps, FilterState, NegotiationModalProps, NavItem, NavMoreSheetProps, NavSection, NegotiationRound (+12 more)
...
Cohesion: 0.09
Nodes (20): CreateNotificationParams, billingNotif, crossTenantQuery, leadNotif, list, markAllForUser1, mockNotifications, notif (+12 more)
...
Cohesion: 0.1
Nodes (17): POST(), ApiAuthContext, ApiErrorResponse, ApiSuccessResponse, idempotencyKeyMap, rateLimitMap, saveIdempotency(), structureFreeTextMeetingNotes() (+9 more)
...
Cohesion: 0.12
Nodes (14): ChoosePlanPage(), PLANS, PlanTier, LoginForm(), DEFAULT_STAGES, OnboardingPage(), OnboardingStep, REGIONS (+6 more)
...
Cohesion: 0.15
Nodes (12): AggregateType, CrmDomainEventName, dispatchPendingOutboxEvents(), DomainEventRecord, emitDomainEvent(), EmitEventInput, inMemoryOutbox, LogContext (+4 more)
...
Cohesion: 0.19
Nodes (13): GET(), POST(), RouteParams, GET(), parsePagination(), POST(), generateCostSheetWhatsAppText(), checkRateLimit() (+5 more)
...
## Knowledge Gaps
- **1731 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1726 more)
...
- **Why does `apiError()` connect `Community 0` to `Community 1`, `Community 34`, `Community 69`, `Community 7`, `Community 8`, `Community 137`, `Community 49`, `Community 26`, `Community 156`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 2` to `Community 5`, `Community 47`, `Community 22`, `Community 55`, `Community 89`, `Community 93`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `reportError()` connect `Community 156` to `Community 0`, `Community 49`, `Community 5`, `Community 22`?**
