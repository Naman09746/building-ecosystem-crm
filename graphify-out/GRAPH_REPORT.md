...
## Corpus Check
- 303 files · ~351,017 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2511 nodes · 5455 edges · 144 communities (136 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b04e17f1`
...
1. `apiError()` - 170 edges
2. `apiSuccess()` - 161 edges
3. `getApiAuthContext()` - 157 edges
4. `getAuthenticatedServerClient()` - 103 edges
5. `useCRM()` - 87 edges
6. `getServiceRoleClient()` - 86 edges
7. `checkRateLimit()` - 78 edges
8. `isLiveSupabaseAvailable` - 77 edges
9. `formatCurrencyINR()` - 60 edges
10. `handleValidationError()` - 58 edges
...
Cohesion: 0.09
Nodes (62): GET(), POST(), GET(), POST(), GET(), POST(), RouteParams, createCommissionSchema (+54 more)
...
Cohesion: 0.1
Nodes (41): POST(), GET(), RouteParams, DELETE(), GET(), POST(), GET(), POST() (+33 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (38): POST(), POST(), checkoutSchema, POST(), POST(), POST(), POST(), POST() (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.14
Nodes (31): CommissionModal(), CommissionModalProps, CostSheetModal(), CostSheetModalProps, NegotiationModal(), NegotiationModalProps, SalespersonHomeProps, SellerOpportunitiesModal() (+23 more)
...
Cohesion: 0.1
Nodes (44): CRMContext, CRMContextType, INITIAL_ACTIVITIES, INITIAL_AREAS, INITIAL_DOCUMENTS, INITIAL_EXTERNAL_ORGS, INITIAL_LEADS, INITIAL_ORG (+36 more)

### Community 9 - "Community 9"
Cohesion: 0.14
Nodes (30): AiAgentCommandCenterProps, PRESET_BUYERS, AiResurrectionModal(), CommandItem, GlobalSearchDialogProps, LeadCard(), LeadCardProps, LeadDetailModal() (+22 more)

### Community 10 - "Community 10"
Cohesion: 0.14
Nodes (30): useCRM(), AiAgentCommandCenter(), AiLeadBot(), BossOverview(), GlobalSearchDialog(), PipelineBoard(), QuickActivityModal(), QuickActivityModalProps (+22 more)
...
Cohesion: 0.1
Nodes (30): acceptInviteSchema, POST(), fetchMetaLeadData(), GET(), isFreshWebhookTime(), parseFieldData(), POST(), timingSafeCompare() (+22 more)
...
Cohesion: 0.07
Nodes (34): bulkImportUnitsSchema, createDocumentSchema, createExternalOrgSchema, createInvitationSchema, createProjectSchema, createRegionSchema, createTaskSchema, executeResurrectionSchema (+26 more)

### Community 19 - "Community 19"
Cohesion: 0.09
Nodes (24): NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer(), NotificationsDrawerProps, billingNotif, crossTenantQuery, leadNotif, list (+16 more)
...
Cohesion: 0.07
Nodes (27): 11. API Audit, 12. Authentication & Authorization, 13. Security Audit, 15. Error Handling & Edge Cases, 16. Testing & Quality, 17. Performance & Scalability, 18. Deployment & Operations, 19. Documentation vs Reality (+19 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (21): createDispatchSchema, GET(), POST(), GET(), POST(), recordBidSchema, DEFAULT_STAGES, GET() (+13 more)
...
Cohesion: 0.17
Nodes (16): AiResurrectionModalProps, MeetingSummaryModal(), MeetingSummaryModalProps, SellerOpportunitiesModalProps, VoiceNoteRecorder(), VoiceNoteRecorderProps, WhatsAppActionModalProps, useVoiceRecorder() (+8 more)
...
Cohesion: 0.14
Nodes (21): GET(), POST(), RouteParams, calculateCostSheet(), CostSheetBreakdown, CostSheetParameters, generateCostSheetWhatsAppText(), getDefaultCostParameters() (+13 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (23): mapActivityRow(), mapActivityType(), mapAreaRow(), mapDocumentRow(), mapExternalOrgRow(), mapFactRow(), mapLeadRow(), mapPersonRow() (+15 more)
...
Cohesion: 0.11
Nodes (18): structureFreeTextMeetingNotes(), confirmMeetingDispositionSchema, createSellerOpportunitySchema, freeTextMeetingSummarySchema, siteVisitBriefingInputSchema, updateSellerOpportunitySchema, criteria, disposition (+10 more)
...
Cohesion: 0.11
Nodes (17): generatePropertyBriefing(), matchBuyersForUnit(), propertyBriefingInputSchema, createEntityRelationshipSchema, createProjectTowerSchema, createProjectUnitSchema, createPropertyAreaSchema, createPropertyFactSchema (+9 more)
...
Cohesion: 0.18
Nodes (10): BillingCustomer, BillingCycle, BillingInvoice, BillingOverviewData, BillingRefund, PlanDefinition, PlanId, PlanPricing (+2 more)
...
Cohesion: 0.33
Nodes (4): checkRateLimitDurable(), RateLimitResult, key, rpcMock
...
## Knowledge Gaps
- **1233 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1228 more)
...
- **Why does `apiError()` connect `Community 3` to `Community 0`, `Community 33`, `Community 4`, `Community 16`, `Community 115`, `Community 24`, `Community 27`, `Community 126`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `apiSuccess()` connect `Community 3` to `Community 0`, `Community 33`, `Community 4`, `Community 16`, `Community 27`, `Community 126`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `getApiAuthContext()` connect `Community 0` to `Community 33`, `Community 3`, `Community 4`, `Community 16`, `Community 24`, `Community 27`, `Community 126`?**
