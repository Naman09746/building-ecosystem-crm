...
## Corpus Check
- 292 files · ~342,776 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2443 nodes · 5153 edges · 150 communities (143 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6c2edd75`
...
1. `apiError()` - 154 edges
2. `apiSuccess()` - 145 edges
3. `getApiAuthContext()` - 141 edges
4. `getAuthenticatedServerClient()` - 88 edges
5. `getServiceRoleClient()` - 86 edges
6. `useCRM()` - 78 edges
7. `checkRateLimit()` - 76 edges
8. `isLiveSupabaseAvailable` - 72 edges
9. `formatCurrencyINR()` - 50 edges
10. `handleValidationError()` - 48 edges
...
- `BottomNav()` --calls--> `useCRM()`  [EXTRACTED]
  Frontend/src/components/layout/bottom-nav.tsx → Frontend/src/context/crm-context.tsx
...
## Communities (150 total, 7 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (55): POST(), checkoutSchema, POST(), POST(), POST(), POST(), POST(), POST() (+47 more)
...
Cohesion: 0.08
Nodes (26): useCRM(), AiAgentCommandCenter(), AiLeadBot(), BossOverview(), GlobalSearchDialog(), PipelineBoard(), QuickActivityModal(), QuickActivityModalProps (+18 more)
...
Cohesion: 0.1
Nodes (40): acceptInviteSchema, POST(), POST(), GET(), RouteParams, GET(), GET(), GET() (+32 more)

### Community 5 - "Community 5"
Cohesion: 0.14
Nodes (32): GET(), POST(), GET(), POST(), RouteParams, GET(), escapeCsvField(), GET() (+24 more)
...
Cohesion: 0.14
Nodes (30): AiAgentCommandCenterProps, PRESET_BUYERS, CommandItem, GlobalSearchDialogProps, LeadCard(), LeadCardProps, LeadDetailModal(), LeadDetailModalProps (+22 more)
...
Cohesion: 0.1
Nodes (26): AiResurrectionModalProps, BillingSuccessView(), MeetingSummaryModalProps, NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer(), NotificationsDrawerProps, SellerOpportunitiesModalProps (+18 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (40): CRMContext, CRMContextType, INITIAL_ACTIVITIES, INITIAL_AREAS, INITIAL_DOCUMENTS, INITIAL_EXTERNAL_ORGS, INITIAL_LEADS, INITIAL_ORG (+32 more)
...
Cohesion: 0.17
Nodes (22): CostSheetModalProps, PlanItem, PLANS_DATA, TeamInvitation, Avatar, AvatarFallback, AvatarImage, Button (+14 more)

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (25): GET(), POST(), DELETE(), GET(), POST(), normalizePhone(), POST(), GET() (+17 more)
...
Cohesion: 0.1
Nodes (26): messageShapeSchema, AriaToolContext, CustomerDossierInput, customerDossierInputSchema, generatePropertyBriefing(), getCustomerDossier(), LookupBuyerInput, lookupBuyerInputSchema (+18 more)
...
Cohesion: 0.09
Nodes (23): DetectSellerSignalsResult, AuditLog, DealHealthFactor, FactCategory, FactVerificationTier, LeadScoreLabel, ListingStatus, Organization (+15 more)

### Community 26 - "Community 26"
Cohesion: 0.12
Nodes (24): mapActivityRow(), mapActivityType(), mapAreaRow(), mapDocumentRow(), mapExternalOrgRow(), mapFactRow(), mapLeadRow(), mapPersonRow() (+16 more)
...
Cohesion: 0.1
Nodes (19): bulkImportUnitsSchema, createDocumentSchema, createInvitationSchema, createProjectSchema, createRegionSchema, importLeadsBatchSchema, updateOrgSettingsSchema, updateProjectSchema (+11 more)

### Community 36 - "Community 36"
Cohesion: 0.1
Nodes (19): 1. Database setup, 2. Environment, 3. Run, 🧠 AI Agents & Automation Modules, Apex Realty CallCRM — Architectural Real Estate Sales & AI Agent Command Center, code:block1 (Real-estate/), code:block2 (supabase/migrations/0001_init.sql        → 0019_phase13_inte), code:bash (cd Frontend) (+11 more)
...
Cohesion: 0.22
Nodes (14): AiResurrectionModal(), CostSheetModal(), StackingChart(), StackingChartProps, UnitDetailModal(), UnitDetailModalProps, formatCurrencyINR(), ProjectsPage() (+6 more)
...
Cohesion: 0.11
Nodes (18): 1. Core Information Architecture Principles, 2. Global Navigation Taxonomy & Structure, 3. Role-Specific Workspaces, 4. End-to-End User Journeys, 5. Navigation Depth & Transition Strategy, 6. Global Command Palette (`⌘K` / `/`) Architecture, A. Salesperson Workspace (Action-First), B. Sales Manager Workspace (Exception & Intervention-First) (+10 more)
...
Cohesion: 0.12
Nodes (16): matchBuyersForUnit(), propertyBriefingInputSchema, createEntityRelationshipSchema, createProjectTowerSchema, createProjectUnitSchema, createPropertyAreaSchema, createPropertyFactSchema, globalSearchQuerySchema (+8 more)
...
Cohesion: 0.14
Nodes (13): createExternalOrgSchema, createTaskSchema, executeResurrectionSchema, globalSearchSchema, idSchema, importLeadRowSchema, reactivateSubscriptionSchema, updateEntityRelationshipSchema (+5 more)
...
Cohesion: 0.18
Nodes (9): DEFAULT_STAGES, GET(), ApiAuthContext, ApiErrorResponse, ApiSuccessResponse, idempotencyKeyMap, rateLimitMap, parseRealEstateVoiceTranscript() (+1 more)
...
Cohesion: 0.29
Nodes (5): LogContext, Logger, LogLevel, REDACTED_KEYS, sanitizeLogData()
...
Cohesion: 0.25
Nodes (6): POST(), validateMessages(), checkRateLimitDurable(), RateLimitResult, key, rpcMock

### Community 91 - "Community 91"
Cohesion: 0.22
Nodes (8): blockedCheck, check, cleaned, hash1, hash2, payload, sensitivePayload, validHmac
...
Cohesion: 0.6
Nodes (4): GET(), POST(), RouteParams, generateCostSheetWhatsAppText()
...
## Knowledge Gaps
- **1217 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `STATIC_ASSETS` (+1212 more)
...
- **Why does `getServiceRoleClient()` connect `Community 4` to `Community 64`, `Community 0`, `Community 98`, `Community 5`, `Community 11`, `Community 48`, `Community 83`, `Community 22`, `Community 25`, `Community 90`, `Community 59`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `isLiveSupabaseAvailable` connect `Community 5` to `Community 0`, `Community 64`, `Community 98`, `Community 68`, `Community 4`, `Community 11`, `Community 17`, `Community 83`, `Community 22`, `Community 120`, `Community 25`, `Community 59`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `apiError()` connect `Community 17` to `Community 0`, `Community 64`, `Community 131`, `Community 4`, `Community 68`, `Community 5`, `Community 83`, `Community 22`, `Community 120`, `Community 90`?**
