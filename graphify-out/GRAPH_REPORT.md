...
## Corpus Check
- 285 files · ~338,571 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2419 nodes · 5091 edges · 137 communities (133 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f4583041`
...
1. `apiError()` - 152 edges
2. `apiSuccess()` - 143 edges
3. `getApiAuthContext()` - 139 edges
4. `getAuthenticatedServerClient()` - 88 edges
5. `getServiceRoleClient()` - 86 edges
6. `useCRM()` - 78 edges
7. `checkRateLimit()` - 74 edges
8. `isLiveSupabaseAvailable` - 72 edges
9. `formatCurrencyINR()` - 48 edges
...
Cohesion: 0.05
Nodes (154): acceptInviteSchema, POST(), GET(), POST(), GET(), POST(), GET(), POST() (+146 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (62): CRMContext, CRMContextType, INITIAL_ACTIVITIES, INITIAL_AREAS, INITIAL_DOCUMENTS, INITIAL_EXTERNAL_ORGS, INITIAL_ORG, INITIAL_PEOPLE (+54 more)
...
Cohesion: 0.07
Nodes (30): ActivityHeatmap(), DAYS, HEATMAP_DATA, HOURS, AreaTrendChart(), DataPoint, DEFAULT_SERIES, CircularProgress() (+22 more)
...
Cohesion: 0.17
Nodes (27): AiAgentCommandCenter(), AiAgentCommandCenterProps, PRESET_BUYERS, CommandItem, GlobalSearchDialog(), GlobalSearchDialogProps, LeadCard(), LeadCardProps (+19 more)
...
Cohesion: 0.09
Nodes (30): CheckoutSessionParams, CheckoutSessionResult, RefundResult, verifyProviderWebhookSignature(), checkLeadQuota(), GatedFeature, isPlanId(), isSubscriptionActive() (+22 more)

### Community 13 - "Community 13"
Cohesion: 0.12
Nodes (23): metadata, BossOverview(), useIsDesktop(), useIsTablet(), BillingPage(), PlanItem, PLANS_DATA, LeadsPageProps (+15 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (8): useAuth(), AiLeadBot(), AppShell(), NotificationBell(), TopBar(), TopBarProps, RegionsPage(), SettingsPage()

### Community 15 - "Community 15"
Cohesion: 0.14
Nodes (22): AiResurrectionModal(), AiResurrectionModalProps, MeetingSummaryModal(), MeetingSummaryModalProps, NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer(), NotificationsDrawerProps (+14 more)

### Community 16 - "Community 16"
Cohesion: 0.18
Nodes (15): BillingSuccessView(), SalespersonHomeProps, SandboxConfirmContent(), metadata, Button, ButtonProps, buttonVariants, Card (+7 more)
...
Cohesion: 0.16
Nodes (19): FilterSheet(), FilterSheetProps, FilterState, BottomNav(), BottomNavProps, NavItem, NavMoreSheet(), NavMoreSheetProps (+11 more)
...
Cohesion: 0.11
Nodes (24): messageShapeSchema, AriaToolContext, CustomerDossierInput, customerDossierInputSchema, getCustomerDossier(), LookupBuyerInput, lookupBuyerInputSchema, lookupDocuments() (+16 more)
...
Cohesion: 0.13
Nodes (23): mapActivityRow(), mapActivityType(), mapDocumentRow(), mapExternalOrgRow(), mapFactRow(), mapLeadRow(), mapPersonRow(), mapProjectRow() (+15 more)

### Community 28 - "Community 28"
Cohesion: 0.13
Nodes (19): fetchMetaLeadData(), GET(), isFreshWebhookTime(), parseFieldData(), POST(), checkIdempotency(), saveIdempotency(), timingSafeCompare() (+11 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (22): cancelSubscriptionSchema, createCheckoutSessionSchema, createRefundSchema, updateBillingProfileSchema, atQuota, expiredGrace, futureGrace, growthOver (+14 more)
...
Cohesion: 0.17
Nodes (18): CostSheetModalProps, calculateCostSheet(), CostSheetBreakdown, CostSheetParameters, generateCostSheetWhatsAppText(), getDefaultCostParameters(), getStandardMilestones(), getStandardStampDutyPct() (+10 more)
...
Cohesion: 0.1
Nodes (18): SearchInventoryInput, searchInventoryInputSchema, authA, authB, criteria, highFloorReq, highResult, invalid (+10 more)
...
Cohesion: 0.18
Nodes (17): InboundLeadParams, ingestInboundLead(), IngestionResult, normalizeBudget(), normalizeConfiguration(), createNotification(), CreateNotificationParams, whatsappWebhookSchema (+9 more)
...
Cohesion: 0.11
Nodes (18): calculateUnitMatchScore(), confirmMeetingDispositionSchema, createSellerOpportunitySchema, freeTextMeetingSummarySchema, siteVisitBriefingInputSchema, updateSellerOpportunitySchema, criteria, disposition (+10 more)

### Community 45 - "Community 45"
Cohesion: 0.11
Nodes (18): mapAreaRow(), generatePropertyBriefing(), matchBuyersForUnit(), propertyBriefingInputSchema, createEntityRelationshipSchema, createProjectTowerSchema, createProjectUnitSchema, createPropertyAreaSchema (+10 more)

### Community 46 - "Community 46"
Cohesion: 0.16
Nodes (16): CostSheetModal(), UnitDetailModal(), UnitDetailModalProps, DealHealth, OccupancyStatus, SellerIntent, UnitStatus, VerificationStatus (+8 more)
...
Cohesion: 0.33
Nodes (9): useCRM(), QuickActivityModal(), QuickActivityModalProps, StructuredOutcome, ActivitiesPage(), TasksPage(), TasksPageProps, Input (+1 more)
...
Cohesion: 0.18
Nodes (11): AuthContext, AuthContextType, AuthOrg, AuthUser, loadProfileUser(), mapDbRole(), OnboardingData, STORAGE_KEYS (+3 more)
...
Cohesion: 0.25
Nodes (6): POST(), validateMessages(), checkRateLimitDurable(), checkFeatureAccess(), key, rpcMock

### Community 92 - "Community 92"
Cohesion: 0.25
Nodes (6): assignments, counts, hmac, payload, reps, result
...
## Knowledge Gaps
- **1207 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1202 more)
...
- **Why does `apiError()` connect `Community 0` to `Community 38`, `Community 12`, `Community 110`, `Community 24`, `Community 91`, `Community 28`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `isLiveSupabaseAvailable` connect `Community 0` to `Community 1`, `Community 38`, `Community 12`, `Community 24`, `Community 28`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `reportError()` connect `Community 110` to `Community 0`, `Community 1`?**
