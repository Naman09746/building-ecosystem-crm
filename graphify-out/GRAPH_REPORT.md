...
## Corpus Check
- 306 files · ~346,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3385 nodes · 6425 edges · 208 communities (201 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ced1de19`
...
- `NavMoreSheet()` --calls--> `useCRM()`  [EXTRACTED]
  Frontend/src/components/layout/nav-more-sheet.tsx → Frontend/src/context/crm-context.tsx
...
- `UnitDetailModal()` --calls--> `useCRM()`  [EXTRACTED]
  Frontend/src/components/crm/unit-detail-modal.tsx → Frontend/src/context/crm-context.tsx

## Communities (208 total, 7 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (68): POST(), checkoutSchema, POST(), POST(), POST(), POST(), POST(), checkIdempotency() (+60 more)
...
Cohesion: 0.12
Nodes (37): AiResurrectionModal(), BillingSuccessView(), CommissionModal(), CostSheetModal(), CostSheetModalProps, N8nIntegrationDrawer(), N8nIntegrationDrawerProps, NegotiationModal() (+29 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (46): acceptInviteSchema, POST(), POST(), n8nInboundPayloadSchema, POST(), GET(), RouteParams, GET() (+38 more)
...
Cohesion: 0.08
Nodes (27): useCRM(), AiAgentCommandCenter(), AiLeadBot(), BossOverview(), GlobalSearchDialog(), PipelineBoard(), QuickActivityModal(), QuickActivityModalProps (+19 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (43): ActivityHeatmap(), DAYS, HEATMAP_DATA, HOURS, AreaTrendChart(), DataPoint, DEFAULT_SERIES, CircularProgress() (+35 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (43): AiAgentCommandCenterProps, PRESET_BUYERS, CommandItem, GlobalSearchDialogProps, LeadCard(), LeadCardProps, LeadDetailModal(), LeadDetailModalProps (+35 more)
...
Cohesion: 0.1
Nodes (28): AiResurrectionModalProps, MeetingSummaryModal(), MeetingSummaryModalProps, NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer(), NotificationsDrawerProps, SellerOpportunitiesModalProps (+20 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (39): POST(), RouteParams, normalizePhone(), POST(), POST(), GET(), parsePagination(), POST() (+31 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (43): getSupabaseClient(), isSupabaseConfigured, activityToRow(), AnyRow, completeTaskRemote(), CrmHydration, deleteDocumentRemote(), deleteProjectRemote() (+35 more)
...
Cohesion: 0.06
Nodes (37): INITIAL_RELATIONSHIPS, INITIAL_SELLER_OPPORTUNITIES, DetectSellerSignalsResult, AuditLog, BuyerRequirement, CommissionLedger, CommissionPaymentStatus, DealHealthFactor (+29 more)
...
Cohesion: 0.18
Nodes (12): DELETE(), GET(), PATCH(), RouteParams, ApiAuthContext, ApiErrorResponse, ApiSuccessResponse, idempotencyKeyMap (+4 more)
...
Cohesion: 0.44
Nodes (8): fraunces, ibmPlexMono, inter, metadata, RootLayout(), viewport, AuthProvider(), CRMProvider()

### Community 99 - "Community 99"
Cohesion: 0.18
Nodes (11): 2.3 Autonomous AI Agent APIs, 2.6 Enterprise Financials & Cost Sheet Calculator API, 2.8 Autonomous AI Agent APIs, 2. API Endpoints Catalog, code:json ({), code:json ({), `POST /api/agent/resurrect`, `POST /api/agent/resurrect` (+3 more)
...
## Knowledge Gaps
- **1742 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1737 more)
...
- **Why does `apiError()` connect `Community 1` to `Community 0`, `Community 129`, `Community 160`, `Community 3`, `Community 11`, `Community 110`, `Community 86`, `Community 23`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 45` to `Community 98`, `Community 5`, `Community 10`, `Community 12`, `Community 21`, `Community 90`, `Community 91`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `reportError()` connect `Community 160` to `Community 1`, `Community 12`, `Community 21`, `Community 63`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
