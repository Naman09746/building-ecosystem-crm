# Graph Report - Real-estate  (2026-08-31)

## Corpus Check
- 308 files · ~350,716 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3470 nodes · 6508 edges · 214 communities (209 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc0553f1`
...
- `POST()` --calls--> `emitDomainEvent()`  [INFERRED]
  Frontend/src/app/api/site-visits/dispatch/route.ts → Frontend/src/lib/server/domain-event-bus.ts
- `SandboxConfirmContent()` --calls--> `formatCurrencyINR()`  [EXTRACTED]
  Frontend/src/app/billing/sandbox-confirm/page.tsx → Frontend/src/lib/utils.ts
- `CRMProvider()` --calls--> `useAuth()`  [EXTRACTED]
  Frontend/src/context/crm-context.tsx → Frontend/src/context/auth-context.tsx
- `Sidebar()` --calls--> `useCRM()`  [EXTRACTED]
  Frontend/src/components/layout/sidebar.tsx → Frontend/src/context/crm-context.tsx
- `CostSheetModal()` --calls--> `useCRM()`  [EXTRACTED]
  Frontend/src/components/crm/cost-sheet-modal.tsx → Frontend/src/context/crm-context.tsx

## Communities (214 total, 5 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (68): POST(), POST(), checkoutSchema, POST(), POST(), POST(), POST(), POST() (+60 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (57): GET(), POST(), GET(), POST(), createCommissionSchema, GET(), POST(), createDispatchSchema (+49 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (70): CRMContext, CRMContextType, INITIAL_ACTIVITIES, INITIAL_AREAS, INITIAL_DOCUMENTS, INITIAL_EXTERNAL_ORGS, INITIAL_ORG, INITIAL_PEOPLE (+62 more)
...
Cohesion: 0.13
Nodes (37): AiAgentCommandCenterProps, PRESET_BUYERS, AiResurrectionModal(), BossOverview(), CommissionModal(), CommandItem, GlobalSearchDialogProps, LeadCard() (+29 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (39): acceptInviteSchema, POST(), POST(), GET(), RouteParams, GET(), POST(), GET() (+31 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (46): POST(), RouteParams, normalizePhone(), POST(), POST(), GET(), parsePagination(), POST() (+38 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (23): useCRM(), AiAgentCommandCenter(), AiLeadBot(), GlobalSearchDialog(), PipelineBoard(), useIsDesktop(), useIsMobile(), useIsTablet() (+15 more)
...
Cohesion: 0.12
Nodes (44): getSupabaseClient(), activityToRow(), AnyRow, completeTaskRemote(), CrmHydration, deleteDocumentRemote(), deleteProjectRemote(), deleteRegionRemote() (+36 more)
...
Cohesion: 0.15
Nodes (24): BillingSuccessView(), CostSheetModal(), CostSheetModalProps, StackingChart(), StackingChartProps, UnitDetailModal(), UnitDetailModalProps, SandboxConfirmContent() (+16 more)
...
Cohesion: 0.08
Nodes (36): mapActivityRow(), mapActivityType(), mapAreaRow(), mapDocumentRow(), mapExternalOrgRow(), mapFactRow(), mapLeadRow(), mapPersonRow() (+28 more)

### Community 21 - "Community 21"
Cohesion: 0.13
Nodes (22): GET(), GET(), POST(), RouteParams, GET(), escapeCsvField(), GET(), generateCostSheetWhatsAppText() (+14 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (26): LandingPage(), ChoosePlanPage(), PLANS, PlanTier, useAuth(), NotificationBell(), LoginForm(), ArchitecturalFloorplanVector() (+18 more)
...
Cohesion: 0.09
Nodes (23): DELETE(), GET(), PATCH(), RouteParams, ApiAuthContext, ApiErrorResponse, ApiSuccessResponse, checkIdempotency() (+15 more)

### Community 25 - "Community 25"
Cohesion: 0.16
Nodes (17): CommissionModalProps, N8nIntegrationDrawerProps, NegotiationModalProps, QuickActivityModal(), QuickActivityModalProps, StructuredOutcome, VoiceNoteRecorder(), VoiceNoteRecorderProps (+9 more)
...
Cohesion: 0.1
Nodes (26): messageShapeSchema, validateMessages(), AriaToolContext, CustomerDossierInput, customerDossierInputSchema, getCustomerDossier(), LookupBuyerInput, lookupBuyerInputSchema (+18 more)

### Community 32 - "Community 32"
Cohesion: 0.17
Nodes (18): AiResurrectionModalProps, MeetingSummaryModal(), MeetingSummaryModalProps, NotificationPreferencesDialog(), NotificationPreferencesDialogProps, NotificationsDrawer(), NotificationsDrawerProps, SellerOpportunitiesModalProps (+10 more)
...
Cohesion: 0.18
Nodes (16): metadata, TopBarProps, PlanItem, PLANS_DATA, TeamInvitation, Avatar, AvatarFallback, AvatarImage (+8 more)
...
Cohesion: 0.19
Nodes (18): fraunces, ibmPlexMono, inter, metadata, RootLayout(), viewport, AuthProvider(), CRMProvider() (+10 more)
...
Cohesion: 0.22
Nodes (15): FilterSheet(), FilterSheetProps, FilterState, NavItem, NavMoreSheetProps, NavSection, ResponsiveModalProps, SheetContent (+7 more)
...
Cohesion: 0.11
Nodes (17): SearchInventoryInput, authA, authB, criteria, highFloorReq, highResult, invalid, lowFloorReq (+9 more)
...
Cohesion: 0.18
Nodes (14): PWARegistrar(), enqueue(), flush(), flushRetries(), givenUpCallbacks, onWriteAbandoned(), pendingRetryCount(), queue (+6 more)
...
Cohesion: 0.14
Nodes (13): calculateUnitMatchScore(), criteria, disposition, invalid, invalidParsed, invalidPayload, match, parsed (+5 more)
...
Cohesion: 0.18
Nodes (11): 2.6 Enterprise Financials & Cost Sheet Calculator API, 2.7 Integration & Domain Event Outbox API, 2.8 Autonomous AI Agent APIs, 2. API Endpoints Catalog, code:json ({), code:json ({), `GET /api/integrations/status`, `POST /api/agent/resurrect` (+3 more)
...
Cohesion: 0.29
Nodes (7): AggregateType, CrmDomainEventName, dispatchPendingOutboxEvents(), DomainEventRecord, emitDomainEvent(), EmitEventInput, inMemoryOutbox

### Community 132 - "Community 132"
Cohesion: 0.32
Nodes (6): CreateNotificationParams, AutomationLogItem, NotificationPreferences, NotificationPriority, NotificationType, SLAConfiguration
...
Cohesion: 0.29
Nodes (6): 1. Component Layering Architecture, 2. Consolidation & Deprecation Strategy, CallCRM 2.0 — Complete UX/UI Master Redesign Blueprint, code:mermaid (graph TD), Section 5: Screen Priority & Impact Matrix (P0–P3), Section 6: Component Strategy & Consolidation Architecture

### Community 151 - "Community 151"
Cohesion: 0.29
Nodes (6): 30. CallCRM UX Scorecard, 31. Complete 11-Phase Implementation Roadmap, CallCRM 2.0 — Master Frontend & System Encyclopedia, code:block8 (PHASE 0: Design Tokens & Foundations (P0)), Master Table of Contents, Part VI: Scorecard & Master Execution Roadmap
...
## Knowledge Gaps
- **1792 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1787 more)
...
- **Why does `apiError()` connect `Community 1` to `Community 0`, `Community 161`, `Community 5`, `Community 6`, `Community 112`, `Community 21`, `Community 24`, `Community 91`, `Community 31`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 22` to `Community 32`, `Community 2`, `Community 37`, `Community 7`, `Community 10`, `Community 47`, `Community 82`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `reportError()` connect `Community 161` to `Community 24`, `Community 1`, `Community 10`, `Community 2`?**
