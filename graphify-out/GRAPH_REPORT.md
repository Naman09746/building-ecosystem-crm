...
## Corpus Check
- 307 files · ~347,985 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3404 nodes · 6443 edges · 210 communities (205 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8c3a414d`
...
- `EmptyState()` --calls--> `cn()`  [EXTRACTED]
  Frontend/src/components/ui/empty-state.tsx → Frontend/src/lib/utils.ts
...
- `AiResurrectionModal()` --calls--> `useCRM()`  [EXTRACTED]
  Frontend/src/components/crm/ai-resurrection-modal.tsx → Frontend/src/context/crm-context.tsx

## Communities (210 total, 5 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (63): POST(), checkoutSchema, POST(), POST(), POST(), POST(), POST(), checkIdempotency() (+55 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (54): GET(), POST(), GET(), POST(), GET(), createCommissionSchema, GET(), POST() (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (44): acceptInviteSchema, POST(), POST(), GET(), RouteParams, DELETE(), GET(), PATCH() (+36 more)
...
Cohesion: 0.06
Nodes (45): ActivityHeatmap(), DAYS, HEATMAP_DATA, HOURS, AreaTrendChart(), DataPoint, DEFAULT_SERIES, CircularProgress() (+37 more)

### Community 5 - "Community 5"
Cohesion: 0.13
Nodes (33): AiResurrectionModal(), BillingSuccessView(), CommissionModal(), CostSheetModal(), CostSheetModalProps, N8nIntegrationDrawer(), N8nIntegrationDrawerProps, NegotiationModal() (+25 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (25): useCRM(), AiAgentCommandCenter(), AiLeadBot(), BossOverview(), GlobalSearchDialog(), PipelineBoard(), SalespersonHome(), useIsMobile() (+17 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (44): POST(), RouteParams, normalizePhone(), POST(), POST(), POST(), PATCH(), RouteParams (+36 more)
...
Cohesion: 0.1
Nodes (43): CRMContext, CRMContextType, INITIAL_ACTIVITIES, INITIAL_AREAS, INITIAL_DOCUMENTS, INITIAL_EXTERNAL_ORGS, INITIAL_LEADS, INITIAL_ORG (+35 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (39): getSupabaseClient(), isSupabaseConfigured, activityToRow(), AnyRow, CrmHydration, deleteProjectRemote(), deleteRegionRemote(), deleteUnitRemote() (+31 more)
...
Cohesion: 0.1
Nodes (28): GET(), POST(), RouteParams, GET(), escapeCsvField(), GET(), generateCostSheetWhatsAppText(), GET() (+20 more)
...
Cohesion: 0.14
Nodes (24): AiAgentCommandCenterProps, PRESET_BUYERS, CommandItem, GlobalSearchDialogProps, LeadCard(), LeadCardProps, LeadDetailModal(), LeadDetailModalProps (+16 more)
...
Cohesion: 0.06
Nodes (36): INITIAL_RELATIONSHIPS, INITIAL_SELLER_OPPORTUNITIES, DetectSellerSignalsResult, AuditLog, BuyerRequirement, CommissionLedger, CommissionPaymentStatus, DealHealthFactor (+28 more)

### Community 23 - "Community 23"
Cohesion: 0.14
Nodes (21): metadata, FilterSheet(), FilterState, useIsDesktop(), useIsTablet(), PlanItem, PLANS_DATA, LeadsPageProps (+13 more)
...
Cohesion: 0.15
Nodes (16): CommissionModalProps, NegotiationModalProps, QuickActivityModal(), QuickActivityModalProps, StructuredOutcome, VoiceNoteRecorder(), VoiceNoteRecorderProps, useVoiceRecorder() (+8 more)
...
Cohesion: 0.14
Nodes (16): LandingPage(), ChoosePlanPage(), PLANS, PlanTier, useAuth(), LoginForm(), DEFAULT_STAGES, OnboardingPage() (+8 more)

### Community 47 - "Community 47"
Cohesion: 0.13
Nodes (15): NotificationPreferencesDialog(), NotificationsDrawer(), NotificationsDrawerProps, NotificationBell(), TopBarProps, NotificationItem, Avatar, AvatarFallback (+7 more)
...
Cohesion: 0.22
Nodes (12): enqueue(), flush(), flushRetries(), givenUpCallbacks, pendingRetryCount(), queue, QueueEntry, reportGiveUp() (+4 more)
...
Cohesion: 0.36
Nodes (9): fraunces, ibmPlexMono, inter, metadata, RootLayout(), viewport, AuthProvider(), CRMProvider() (+1 more)
...
Cohesion: 0.29
Nodes (9): ArchitecturalFloorplanVector(), ExecutiveDarkCockpit(), HeroDossierPreview(), HeroEditorialVisual(), IsometricCityscape(), MobileCompanionDeviceFrame(), PhysicalSiteVisitShowcase(), RealEstateRelationshipDiagram() (+1 more)

### Community 95 - "Community 95"
Cohesion: 0.2
Nodes (11): AuthContext, AuthContextType, AuthOrg, AuthUser, loadProfileUser(), loadProfileUserAndOrg(), mapDbRole(), OnboardingData (+3 more)
...
Cohesion: 0.36
Nodes (8): lead, leadWithUnit, lostLead, setup(), targets, task, useTestCRM(), wrapper()
...
Cohesion: 0.22
Nodes (8): BillingCustomer, BillingInvoice, BillingOverviewData, BillingRefund, PlanDefinition, PlanPricing, Subscription, SubscriptionStatus
...
Cohesion: 0.29
Nodes (5): POST(), checkRateLimitDurable(), RateLimitResult, key, rpcMock
...
Cohesion: 0.47
Nodes (4): createProjectUnitSchema, GET(), POST(), RouteParams

### Community 164 - "Community 164"
Cohesion: 0.4
Nodes (5): GET(), parsePagination(), POST(), createLeadSchema, idSchema
...
## Knowledge Gaps
- **1751 isolated node(s):** `config`, `config`, `securityHeaders`, `nextConfig`, `email` (+1746 more)
...
- **Why does `apiError()` connect `Community 1` to `Community 0`, `Community 2`, `Community 163`, `Community 164`, `Community 133`, `Community 162`, `Community 7`, `Community 14`, `Community 111`, `Community 88`, `Community 31`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 46` to `Community 6`, `Community 10`, `Community 47`, `Community 89`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `reportError()` connect `Community 162` to `Community 1`, `Community 10`, `Community 14`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
